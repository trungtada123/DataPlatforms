...
import { extractToolDataTables } from "../evidenceTables";
import { extractMergedContext } from "../mergedContext";
import { extractSqlSnippets } from "../types";
import { AnswerBlock } from "./AnswerBlock";
import { DebugPanel } from "./DebugPanel";
import { IntentClassifierPanel } from "./IntentClassifierPanel";
import { MergedContextPanel } from "./MergedContextPanel";
import { MetaGrid } from "./MetaGrid";
import { PipelineProgress } from "./PipelineProgress";
import { SqlBlock } from "./SqlBlock";
import { ToolDataTables } from "./ToolDataTables";
...
export function ResultPanel({ data }: ResultPanelProps) {
  ...
  const dataTables = extractToolDataTables(data);
  const mergedContext = extractMergedContext(data);
  ...
  return (
    <section className="card result-card">
      ...
      <ToolDataTables tables={dataTables} />

      {mergedContext ? <MergedContextPanel context={mergedContext} /> : null}
