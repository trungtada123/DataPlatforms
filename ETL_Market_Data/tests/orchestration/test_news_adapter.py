...
from agents.news_agent.schemas import NewsCrawledArticle, NewsToolResponse
from orchestration.contracts import IntentPlan, ToolExecutionRequest, ToolExecutionStatus, ToolName
from orchestration.news_adapter import NewsToolAdapter
...
class NewsAdapterTests(TestCase):
    ...
    def test_maps_news_tool_response_to_tool_execution_result(self) -> None:
        ...
        with patch("orchestration.news_adapter.NewsToolService") as service_cls:
