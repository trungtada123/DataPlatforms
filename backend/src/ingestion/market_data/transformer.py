"""Data normalization and feature calculations for market ingestion."""
...
def normalize_security_details(raw_payload: dict[str, Any]) -> dict[str, Any] | None:
    """Flatten the nested SSI security detail response into the symbols schema."""
...
def normalize_daily_raw_rows(symbol: str, raw_rows: Iterable[dict[str, Any]]) -> list[dict[str, Any]]:
    """Map SSI DailyStockPrice rows into normalized raw daily schema."""
